                                            ...
                                            <div x-show="transferModalOpen" x-cloak x-transition @keydown.escape.window="transferModalOpen = false" class="fixed inset-0 z-[1300] flex items-start justify-center overflow-y-auto px-4 pt-30" role="dialog" aria-modal="true">
                                                <div class="w-full max-w-lg rounded-md border border-gray-200 bg-white p-6 shadow-md dark:border-gray-700 dark:bg-gray-900">
                                                    ...
                                                    <div class="space-y-4">
                                                        ...
                                                        <div>
                                                            <label class="text-start mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">Transfer To</label>
                                                            <select class="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-blue-500 focus:outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-white">
                                                        ...
                                                        <div>
                                                            <label class="text-start mb-1 block text-sm font-medium text-gray-700 dark:text-gray-200">Notes</label>
                                                            <textarea rows="4" class="w-full rounded-md border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 focus:border-blue-500 focus:outline-none dark:border-gray-700 dark:bg-gray-800 dark:text-white" placeholder="Reason for transfer"></textarea>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="mt-6 flex justify-end gap-2">
                                                        ...
                                                        <button type="button" @click="transferModalOpen = false" class="rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-blue-700">
                                                            Request Transfer
                                                        </button>
                                                    </div>
                                                </div>
